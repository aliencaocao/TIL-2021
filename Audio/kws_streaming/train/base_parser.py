...
def base_parser():
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='backward,bird,cat,chicken,crocodile,dinosaur,dog,down,eight,elephant,falcon,five,forward,four,go,left,nine,one,right,seven,six,snake,stop,three,two,up,zero',  # change here
  ...
  parser.add_argument(
      '--preemph',
      type=float,
      default=0.97,  # Default 0.0 (disabled)
